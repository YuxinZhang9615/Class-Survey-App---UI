...
dashboardPage(
  dashboardHeader( #title = "Class Survey",
    title = "Class Survey",tags$li(a(href = 'http://stat.psu.edu/.com',
                                     img(src = 'logo5.png',
    ...
    tabItems(
      ...
      tabItem(tabName = "questionaire",
              ...
              fluidRow(column(4,offset = 8,
                              textInput("ccQ","Please enter a class code"),
                              actionButton("submitQ","Submit")))
      ...
      tabItem(tabName = "survey",
              fluidPage(
                fluidRow(
                  column(3,textInput("ccA","Please enter the class code:")),
                ...
                hr(),
                fluidRow(
                  column(1,offset = 11,actionButton("submitA","Submit"))
                )
              )),
      ...
      tabItem(tabName = "result",
              fluidPage(
                fluidRow(
                  column(3,textInput("ccR","Please enter the class code:")),
